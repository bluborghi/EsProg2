...
{
    if (l == NULL || strcmp(e->inf, head(l)) < 0)
...
void naviga(elem *e)
{
    ...
    do
    {
        ...
        cin >> scelta;
        if (scelta == 'F' && e->pun != NULL)
        {
            cout << head(tail(e->pun)) << endl;
            e = tail(e);
        }
        else if (scelta == 'B' && e->prev != NULL)
        {
            cout << head(e->prev) << endl;
            e = prev(e);
        }
        else
...
int main()
{
    ...
    do
    {
        ...
        {
        case 1:
            cout << "Come vuoi creare la lista (1:ordinata,0:non ordinata)?" << endl;
            cin >> ordinata;
